...
Feature: Common EAP tests
  ...
  Scenario: Check if image version and release is printed on boot
    ...
    Then container log should contain Running jboss-eap-7 @jboss-eap-7-tech-preview/eap-cd-openshift image, version
  ...
  Scenario: Check that the labels are correctly set
    ...
    Then the image should contain label com.redhat.component with value jboss-eap-7-eap-cd-openshift-container
     And the image should contain label name with value jboss-eap-7 @jboss-eap-7-tech-preview/eap-cd-openshift
  ...
  Scenario: Check for add-user failures
    When container is ready
    Then container log should contain Running jboss-eap-7 @jboss-eap-7-tech-preview/eap-cd-openshift image
  ...
  Scenario: jgroups-encrypt
    ...
    Then XML file /opt/eap/standalone/configuration/standalone-openshift.xml should have 2 elements on XPath //*[local-name()="encrypt-protocol"][@type="SYM_ENCRYPT"]
